document.addEventListener("DOMContentLoaded", () => {
    ...
    if (!isTouchDevice && dot && outline) {
        ...
        function animateCursor() {
            ...
            butterflyX += (mouseX - butterflyX) * 0.18;
            butterflyY += (mouseY - butterflyY) * 0.18;

            // Using translate3d for GPU acceleration
            dot.style.transform = `translate3d(${dotX - 5}px, ${dotY - 5}px, 0)`;
            outline.style.transform = `translate3d(${outX - 23}px, ${outY - 23}px, 0)`;
            if (butterfly) {
                const tilt = Math.max(-18, Math.min(18, (butterflyX - lastButterflyX) * 0.8));
                butterfly.style.transform = `translate3d(${butterflyX + 14}px, ${butterflyY - 18}px, 0) rotate(${tilt}deg)`;
